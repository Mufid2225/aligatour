...
const destinations = [
  { name: "Panorama Tumpak Sewu", image: "/destinations/tumpak-sewu/panoramic-tumpak-sewu.webp" },
  { name: "Goa Tetes", image: "/destinations/tumpak-sewu/goa-tetes.webp" },
  { name: "Dasar Air Terjun Tumpak Sewu", image: "/destinations/tumpak-sewu/dasar-air-terjun-tumpak-sewu.webp" },
  { name: "Telaga Biru", image: "/destinations/tumpak-sewu/telaga-biru.webp" },
];
const includes = [
