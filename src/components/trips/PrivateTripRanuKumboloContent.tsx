...
const facilities = [
  ...
  { title: "Insta360 Ace Pro 2", noteKey: "limited", image: "/facilities/insta360-ace.webp" },
  { title: "Gimbal", noteKey: "limited", image: "/facilities/gimbal.webp" },
];
  ...
  return (
    <main className="min-h-screen bg-[#fbfcf8]">
      ...
      <section className="relative min-h-[620px] overflow-hidden bg-[#153d37] text-white">
        <Image
          src="/trip-cards/ranu-kumbolo.jpg"
