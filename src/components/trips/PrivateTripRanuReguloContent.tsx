...
const facilities = [
  ...
  { title: "Insta360 X4 Air", note: "Limited", image: "/facilities/insta360-x4.webp" },
  { title: "Gimbal", note: "Limited", image: "/facilities/gimbal.webp" },
];
  ...
  return (
    <main className="min-h-screen bg-[#fbfcf8]">
      ...
      <section className="relative min-h-[620px] overflow-hidden bg-[#153d37] text-white">
        <Image src="/trip-cards/ranu-regulo1.webp" alt="Danau Ranu Regulo" fill priority sizes="100vw" className="object-cover opacity-60" />
