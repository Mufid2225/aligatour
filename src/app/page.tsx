...
const trips = [
  {title:"Malang-Batu City Tour", place:"Malang & Kota Batu", price:"500.000", unit:"/mobil", days:"Private - 4 kursi", rating:"4.9", image:withBasePath("/trip-cards/malang-batu-city-tour.webp"), tag:"Bebas pilih destinasi", href:withBasePath("/trips/malang-batu-city-tour")},
  {title:"Private Shuttle Ranu Pane", place:"Malang -> Basecamp Ranu Pane", price:"8xx.xxx", unit:"/mobil", days:"PP - 1-10 kursi", rating:"4.9", image:withBasePath("/trip-cards/private-shuttle-ranu-pane.webp"), tag:"Gratis shelter H-1", href:withBasePath("/trips/private-shuttle-ranu-pane")},
  {title:"Private Trip Ranu Kumbolo", place:"Semeru, Jawa Timur", price:"2.200.000", unit:"/grup", days:"2 Hari 1 Malam - 2-4 orang", rating:"4.9", image:withBasePath("/trip-cards/ranu-kumbolo.jpg"), tag:"3 pilihan paket", href:withBasePath("/trips/private-trip-ranu-kumbolo")},
  {title:"Private Trip Tumpak Sewu", place:"Area Kota Malang", price:"400.000", unit:"/orang", days:"Private - min. 3 orang", rating:"4.8", image:withBasePath("/trip-cards/tumpak-sewu.jpg"), tag:"Free panorama kipas baru", href:withBasePath("/trips/open-trip-tumpak-sewu")},
  {title:"Private Trip Pantai Malang", place:"Pantai Malang Selatan", price:"200.000", unit:"/orang", days:"Maks. 2 pantai", rating:"4.9", image:withBasePath("/trip-cards/pantai-malang.webp"), tag:"Bebas pilih pantai", href:withBasePath("/trips/private-trip-pantai-malang")},
  {title:"Private Trip Bromo", place:"Meeting point Kota Malang", price:"1.800.000", unit:"/grup", days:"Private - Maks. 5 orang", rating:"4.9", image:"https://images.unsplash.com/photo-1588668214407-6ea9a6d8c272?auto=format&fit=crop&w=1000&q=85", tag:"3 pilihan paket", href:withBasePath("/trips/private-trip-bromo")},
];
