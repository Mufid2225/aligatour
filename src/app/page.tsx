...
const trips = [
  {title:"Malang–Batu City Tour", place:"Malang & Kota Batu", price:"500.000", unit:"/mobil", days:"Private · 4 kursi", rating:"4.9", image:"/malang-batu-city-tour.webp", tag:"Bebas pilih destinasi", href:"/trips/malang-batu-city-tour"},
  {title:"Private Shuttle Ranu Pane", place:"Malang ↔ Basecamp Ranu Pane", price:"8xx.xxx", unit:"/mobil", days:"PP · 1–10 kursi", rating:"4.9", image:"/private-shuttle-ranu-pane-card.webp", tag:"Gratis shelter H-1", href:"/trips/private-shuttle-ranu-pane"},
  {title:"Private Trip Ranu Kumbolo", place:"Semeru, Jawa Timur", price:"2.200.000", unit:"/grup", days:"2 Hari 1 Malam · 2–4 orang", rating:"4.9", image:"/ranu-kumbolo-card.jpg", tag:"3 pilihan paket", href:"/trips/private-trip-ranu-kumbolo"},
  {title:"Open Trip Tumpak Sewu", place:"Meeting point Malang & Batu", price:"350.000", unit:"/orang", days:"1 Hari · Per orang", rating:"4.8", image:"/tumpak-sewu-card.jpg", tag:"Berangkat setiap hari", href:"/trips/open-trip-tumpak-sewu"},
  {title:"Private Trip Pantai Malang", place:"Pantai Malang Selatan", price:"200.000", unit:"/orang", days:"Maks. 2 pantai", rating:"4.9", image:"/pantai-malang-card.webp", tag:"Bebas pilih pantai", href:"/trips/private-trip-pantai-malang"},
